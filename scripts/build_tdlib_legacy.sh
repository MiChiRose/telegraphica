...
CLEAN=0
ALLOW_UNKNOWN_TAG=0
PATCH_LEGACY_LINKER="${PATCH_LEGACY_LINKER:-1}"
PATCH_MAVERICKS_FDOPENDIR="${PATCH_MAVERICKS_FDOPENDIR:-1}"
PATCH_MAVERICKS_CLOCK_GETTIME="${PATCH_MAVERICKS_CLOCK_GETTIME:-1}"
PATCH_WEBPAGES_MANAGER_STACK_ADDRESS_WARNING="${PATCH_WEBPAGES_MANAGER_STACK_ADDRESS_WARNING:-1}"
PATCH_XCODE5_SCOPE_EXIT_HEAP_GUARD="${PATCH_XCODE5_SCOPE_EXIT_HEAP_GUARD:-1}"
PATCH_XCODE5_FILEFD_SCOPE_EXIT="${PATCH_XCODE5_FILEFD_SCOPE_EXIT:-1}"
PATCH_XCODE5_STATUS_SCOPE_EXIT="${PATCH_XCODE5_STATUS_SCOPE_EXIT:-1}"
PATCH_XCODE5_IPADDRESS_SCOPE_EXIT="${PATCH_XCODE5_IPADDRESS_SCOPE_EXIT:-1}"
PATCH_XCODE5_STDSTREAMS_SCOPE_EXIT="${PATCH_XCODE5_STDSTREAMS_SCOPE_EXIT:-1}"
PATCH_XCODE5_ORDERED_EVENTS_RESIZE="${PATCH_XCODE5_ORDERED_EVENTS_RESIZE:-1}"
PATCH_LOGEVENT_PARSER_STATUS="${PATCH_LOGEVENT_PARSER_STATUS:-1}"
PATCH_NETSTATS_PARSE_GUARD="${PATCH_NETSTATS_PARSE_GUARD:-1}"
PATCH_THEME_CHAT_THEMES_PARSE_GUARD="${PATCH_THEME_CHAT_THEMES_PARSE_GUARD:-1}"
PATCH_MESSAGES_NOTIFICATION_SETTINGS_PARSE_GUARD="${PATCH_MESSAGES_NOTIFICATION_SETTINGS_PARSE_GUARD:-1}"
PATCH_STICKERS_DATABASE_PARSE_GUARD="${PATCH_STICKERS_DATABASE_PARSE_GUARD:-1}"
PATCH_CONTACTS_USER_PARSE_GUARD="${PATCH_CONTACTS_USER_PARSE_GUARD:-1}"
PATCH_CONTACTS_LIST_PARSE_GUARD="${PATCH_CONTACTS_LIST_PARSE_GUARD:-1}"
PATCH_CONTACTS_CHAT_PARSE_GUARD="${PATCH_CONTACTS_CHAT_PARSE_GUARD:-1}"
PATCH_CONTACTS_CHANNEL_PARSE_GUARD="${PATCH_CONTACTS_CHANNEL_PARSE_GUARD:-1}"
PATCH_CONTACTS_SECRET_CHAT_PARSE_GUARD="${PATCH_CONTACTS_SECRET_CHAT_PARSE_GUARD:-1}"
