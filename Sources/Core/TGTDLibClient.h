...
- (BOOL)setCurrentUserProfilePhotoAtPath:(NSString *)localPath timeout:(NSTimeInterval)timeout error:(NSError **)error;
...
- (NSString *)sendTextMessageToChatID:(NSNumber *)chatID messageThreadID:(NSNumber *)messageThreadID messageTopicKind:(NSString *)messageTopicKind text:(NSString *)text replyToMessageID:(NSNumber *)replyToMessageID sendOptions:(NSDictionary *)sendOptions timeout:(NSTimeInterval)timeout error:(NSError **)error;
...
- (NSString *)sendContactMessageToChatID:(NSNumber *)chatID messageThreadID:(NSNumber *)messageThreadID messageTopicKind:(NSString *)messageTopicKind firstName:(NSString *)firstName lastName:(NSString *)lastName phoneNumber:(NSString *)phoneNumber replyToMessageID:(NSNumber *)replyToMessageID timeout:(NSTimeInterval)timeout error:(NSError **)error;
- (NSString *)sendLocationMessageToChatID:(NSNumber *)chatID messageThreadID:(NSNumber *)messageThreadID messageTopicKind:(NSString *)messageTopicKind latitude:(double)latitude longitude:(double)longitude replyToMessageID:(NSNumber *)replyToMessageID timeout:(NSTimeInterval)timeout error:(NSError **)error;
