...
NSRect TGLinkPreviewCardRectForItem(TGMessageItem *item, NSRect bubbleRect, BOOL showSenderDetails, BOOL flipped);
void TGDrawLinkPreviewCardForItem(TGMessageItem *item, NSRect cardRect, BOOL outgoing, BOOL flipped);
