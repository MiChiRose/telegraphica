...
@property (nonatomic, retain) NSSegmentedControl *mediaCenterTabControl;
...
@synthesize mediaCenterTabControl = _mediaCenterTabControl;
...
- (void)dealloc {
    ...
    [_mediaCenterTabControl release];
