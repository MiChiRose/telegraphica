...
| Media | Per-chat media center plus shared Download Manager, filtering, pagination, progress, retry/cancel, restart recovery through TDLib file IDs, Save As, Finder reveal, cache delete, preview/playback, independent 1x/1.5x/2x audio/video speeds, and separate photo/video/document/voice auto-download controls | Progressive playback, quality, playlists and per-chat/type cache cleanup |
