...
| Media | Per-chat media center plus shared Download Manager, filtering, pagination, progress, retry/cancel, restart recovery through TDLib file IDs, Save As, Finder reveal, cache delete, preview/playback, and separate photo/video/document/voice auto-download controls | Progressive playback, speed, quality, playlists and per-chat/type cache cleanup |
