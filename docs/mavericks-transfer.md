...
The table displays local account data. Do not post screenshots of real chat
titles, unread counts, or account metadata outside the private validation loop.
